...
/**
 * @brief Add a control to the control manager.
 * @return Returnt the index were the control is stored.
 */
...
/**
 * @brief Add a peripheral to the control manager.
 * @return Returnt the index were the peripheral is stored.
 */
